...
<div class="col-lg-3 ser  "  style="background-color:white">
              <div class="cotainer" style="font-size:7vw;text-align:center;color:#ED9D2B;"><a href="servicemakeupartist.php"><i class="fas fa-smile"></i></a>

<h5>Make up artist</h5>

</div></div>
<div class="col-lg-3 ser  "  style="background-color:white">
              <div class="cotainer" style="font-size:7vw;text-align:center;color:#ED9D2B;"><a href="servicegiftmaker.php"><i class="fas fa-gifts"></i></a>
